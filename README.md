...
- **Social** — friends (your "Coven"), a directed "Inner Coffin" inner circle, photo posts/stories about your plushes, likes + comments, and a MySpace-style **Top 8 Buns** showcase on your profile (everyone starts with Tom — the hidden mascot — as their first pick). Posts are scoped Public / Coven / Inner Coffin, enforced in the database via RLS. Account required (no anonymous viewing). Backed by migration `db/0021_social.sql`.
